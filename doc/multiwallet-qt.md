...
In order to support loading of multiple wallets in oro-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is oro.cpp.
...
Changes to oro.cpp
----------------------
oro.cpp is the entry point into oro-qt, and as such, will require some minor modifications to provide hooks for
