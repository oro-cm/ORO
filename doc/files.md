...
oro.conf           | contains configuration settings for orod or oro-qt
orod.pid           | stores the process id of orod while running
...
debug.log           | contains debug information and general logging generated by orod or oro-qt
