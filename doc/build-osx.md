...
It's now available at `./orod`, provided that you are still in the `src`
...
-------
    ...
    ./orod -daemon # to start the oro daemon.
    ./oro-cli --help  # for a list of command-line options.
    ./oro-cli help    # When the daemon is running, to get a list of RPC commands
