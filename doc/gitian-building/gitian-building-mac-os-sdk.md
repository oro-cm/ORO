...
The script [extract-osx-sdk.sh](https://github.com/oro-project/oro/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
oro/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/oro-project/oro/blob/master/doc/README_osx.md) for troubleshooting tips.