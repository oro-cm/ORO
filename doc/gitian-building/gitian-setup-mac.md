...
The build script we'll be using is contained in the ORO github repository ([contrib/gitian-build.py](https://github.com/oro-project/oro/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the ORO repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/ORO-Project/ORO/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, oro-detached-sigs, and oro GitHub repos.
