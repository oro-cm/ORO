Contributing to ORO Core
============================

The ORO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ORO Core project, and is not to be
confused with overall ORO Network Protocol consensus changes.

Whether a pull request is merged into ORO Core rests with the project merge
...
Where a patch set proposes to change the ORO consensus, it must have been
...
The project leader is the release manager for each ORO Core release.
