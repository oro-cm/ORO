...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\ORO
// Windows >= Vista: C:\Users\Username\AppData\Roaming\ORO
// Mac: ~/Library/Application Support/ORO
// Unix: ~/.oro
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ORO";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "oro.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "orod.pid"));
