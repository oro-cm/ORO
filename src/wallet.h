...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 ORO at the same time
...
public:
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzOROTracker> zpivTracker;
    ...
    {
        zwalletMain = zwallet;
        zpivTracker = std::unique_ptr<CzOROTracker>(new CzOROTracker(strWalletFile));
    }

    CzOROWallet* getZWallet() { return zwalletMain; }
