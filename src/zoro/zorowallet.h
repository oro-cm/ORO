...
#ifndef ORO_ZOROWALLET_H
#define ORO_ZOROWALLET_H
...
public:
    CzOROWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZORO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZORO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
