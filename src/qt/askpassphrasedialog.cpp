...
#include "qt/oro/loadingdialog.h"
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            if (newpass1 == newpass2) {
                ...
                OROGUI* window = static_cast<OROGUI*>(parentWidget());
...
{
    OROGUI* gui = static_cast<OROGUI*>(parentWidget());
...
{
    hide();
    static_cast<OROGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
