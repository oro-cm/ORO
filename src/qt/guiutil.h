...
/** Utility functions used by the ORO Qt UI.
 */
namespace GUIUtil
{
...
// Render ORO addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZoro = false);
...
// Parse "oro:" URI into recipient object, return true on successful parsing
