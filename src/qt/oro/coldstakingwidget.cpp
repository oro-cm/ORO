...
#include "qt/oro/coldstakingwidget.h"
#include "qt/oro/forms/ui_coldstakingwidget.h"
#include "qt/oro/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/oro/requestdialog.h"
#include "qt/oro/tooltipmenu.h"
#include "qt/oro/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(OROGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your OROs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept ORO delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select ORO outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 ORO" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
