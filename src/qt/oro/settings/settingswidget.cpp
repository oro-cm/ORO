...
#include "qt/oro/settings/forms/ui_settingswidget.h"
#include "qt/oro/settings/settingsbackupwallet.h"
#include "qt/oro/settings/settingsbittoolwidget.h"
#include "qt/oro/settings/settingswalletrepairwidget.h"
#include "qt/oro/settings/settingswalletoptionswidget.h"
#include "qt/oro/settings/settingsmainoptionswidget.h"
#include "qt/oro/settings/settingsdisplayoptionswidget.h"
#include "qt/oro/settings/settingsmultisendwidget.h"
#include "qt/oro/settings/settingsinformationwidget.h"
#include "qt/oro/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(OROGUI* parent) :
    PWidget(parent),
