...
#include "qt/oro/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/oro/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(OROGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to OROGUI::handleRestart()
