...
#include "qt/oro/settings/settingssignmessagewidgets.h"
#include "qt/oro/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(OROGUI* _window, QWidget *parent) :
