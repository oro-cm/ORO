...
#include "qt/oro/settings/settingsnetworkwidget.h"
#include "qt/oro/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/oro/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OROGUI* _window, QWidget *parent) :
