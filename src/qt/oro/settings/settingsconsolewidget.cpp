...
#include "qt/oro/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/oro/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(OROGUI* _window, QWidget *parent) :
