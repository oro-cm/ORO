...
#include "qt/oro/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 41001");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("41003");
    } else {
        ui->lineEditPort->setText("41001");
    }
