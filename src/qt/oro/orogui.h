...
#ifndef ORO_CORE_NEW_GUI_OROGUI_H
#define ORO_CORE_NEW_GUI_OROGUI_H
...
#include "qt/oro/navmenuwidget.h"
#include "qt/oro/topbar.h"
#include "qt/oro/dashboardwidget.h"
#include "qt/oro/send.h"
#include "qt/oro/receivewidget.h"
#include "qt/oro/addresseswidget.h"
#include "qt/oro/privacywidget.h"
#include "qt/oro/coldstakingwidget.h"
#include "qt/oro/masternodeswidget.h"
#include "qt/oro/snackbar.h"
#include "qt/oro/settings/settingswidget.h"
...
/**
  ORO GUI main class. This class represents the main window of the ORO UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class OROGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit OROGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~OROGUI();
...
#endif //ORO_CORE_NEW_GUI_OROGUI_H
