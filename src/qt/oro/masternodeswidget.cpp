...
#include "qt/oro/forms/ui_masternodeswidget.h"
#include "qt/oro/qtutils.h"
#include "qt/oro/mnrow.h"
#include "qt/oro/mninfodialog.h"

#include "qt/oro/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(OROGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:41001 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
