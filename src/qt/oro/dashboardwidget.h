...
#include "config/oro-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalOro = 0;
    qint64 totalZoro = 0;
    QList<qreal> valuesOro;
    QList<qreal> valueszOro;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(OROGUI* _window);
    ~DashboardWidget();
