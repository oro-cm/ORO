...
#include "qt/oro/forms/ui_receivewidget.h"
...
#include "qt/oro/addressholder.h"
...
ReceiveWidget::ReceiveWidget(OROGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive ORO."));
