...
#include "qt/oro/furabstractlistitemdelegate.h"
#include "qt/oro/txviewholder.h"
#include "qt/oro/tooltipmenu.h"
#include "qt/oro/sendmultirow.h"
#include "qt/oro/coldstakingmodel.h"
#include "qt/oro/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(OROGUI* parent);
    ~ColdStakingWidget();
