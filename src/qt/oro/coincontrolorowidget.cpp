...
#include "qt/oro/coincontrolorowidget.h"
#include "qt/oro/forms/ui_coincontrolorowidget.h"

CoinControlOroWidget::CoinControlOroWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlOroWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select ORO Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ORO");
    ...
    ui->labelValueAfter->setText("0.00 ORO");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ORO");
    ui->labelValueFee->setText("0.00 ORO");
...
CoinControlOroWidget::~CoinControlOroWidget()
{
    delete ui;
}
