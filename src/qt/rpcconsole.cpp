                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzOROPathCustom = GetArg("-zorobackuppath", "");
    ...
    if(!strzOROPathCustom.empty()) {
        ui->wallet_customzorobackuppath->setText(QString::fromStdString(strzOROPathCustom));
        ui->wallet_customzorobackuppath_label->setVisible(true);
        ui->wallet_customzorobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzOROPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ORO RPC console.") + "<br>" +
