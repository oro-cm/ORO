...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000002a93a59d379f6c4c5ce32032e66edba84f4b3faa15fc941898fcc172052"))
    (100, uint256("00000126effa5da572eaf00af96d63304ca2188df70a3a292b1b23bf74cb228d"))
    (1500, uint256("bde4c1155964f8442a4d98d5ff15b0ca55fb0d8d6424b4529cf73dfed23eb196")) //first block to use modifierV2
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04ccdc085c2cdedb44086e7edbb560a82c5c9d39a3c4805514c8ac334e960b9e543c15c1541e1843a25bd44ae108a074c6df3f561557d576707e07a47a30d75893");
        nDefaultPort = 41001;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ORO: 1 day
        nTargetSpacing = 1 * 15;  // ORO: 0.5 minute
        nMaturity = 30;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "ORO Genesis Block: 2019/01/25 12:00:00";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1548364000;
        genesis.nBits = 0x1e0fffff;

        genesis.nNonce = 776022;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000002a93a59d379f6c4c5ce32032e66edba84f4b3faa15fc941898fcc172052"));
        assert(genesis.hashMerkleRoot == uint256("0xa8984b56071a52bc851a5d41b14bcd4ce3de9a3f419569ce8bc43fceff58b5e9"));

        // vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "oro.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        // vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "oro.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        ...
        strSporkKey = "04cdb4f799cf243416bc88c1baca31566236cb8ee07ae2884ee24c14704f4fa2aecdd95a33f2d9abb31cabc9c7eecafe45f7435ecd0d59bc570b51f73646fa6cf9";
        strSporkKeyOld = "04fa722fe77b728fc16e7f8285a324346695d2b0190bf2b4ef944480b71638daca9ecf3d1e83b469eaa2cec23f99a10c0f2e7f6dd831cd8d0f56b1cf32d1e714d3";
        strObfuscationPoolDummyAddress = "D87q2gC9j6nNrnzCsg4aY6bHMLsT9nUhEw";
        nStartMasternodePayments = 1999999999; //Wed, 25 Jun 2014 20:36:16 GMT
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ORO: 1 day
        nTargetSpacing = 1 * 60;  // ORO: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "oro-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "oro-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet oro addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet oro script addresses start with '8' or '9'
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // ORO: 1 day
        nTargetSpacing = 1 * 60;        // ORO: 1 minutes
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51476;
        assert(hashGenesisBlock == uint256("0x1713843fccfa639af3398de97811f6164c3d6a84f50a6a7f091f4eb173561ac3"));
