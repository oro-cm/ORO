...
bool CWalletDB::WriteZOROSeed(const uint256& hashSeed, const vector<unsigned char>& seed)
{
...
bool CWalletDB::ReadZOROSeed(const uint256& hashSeed, vector<unsigned char>& seed)
{
