 ...
 * ORO system. There are three: the main network on which people trade goods
...
public:
    ...
    int OroBadBlockTime() const { return nOroBadBlockTime; }
    int OroBadBlocknBits() const { return nOroBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nOroBadBlockTime;
    unsigned int nOroBadBlocknBits;
