...
extern UniValue DoZoroSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
// extern UniValue setzoroseed(const UniValue& params, bool fHelp);
// extern UniValue getzoroseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
// extern UniValue searchdzoro(const UniValue& params, bool fHelp);
// extern UniValue dzorostate(const UniValue& params, bool fHelp);
