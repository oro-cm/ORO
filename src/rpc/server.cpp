...
UniValue ValueFromAmount(const CAmount& amount)
{
    ...
    return UniValue(UniValue::VNUM,
            strprintf("%s%d.%03d", sign ? "-" : "", quotient, remainder));
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ORO features */
        {"oro", "listmasternodes", &listmasternodes, true, true, false},
        {"oro", "getmasternodecount", &getmasternodecount, true, true, false},
        {"oro", "masternodeconnect", &masternodeconnect, true, true, false},
        {"oro", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"oro", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"oro", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"oro", "masternodecurrent", &masternodecurrent, true, true, false},
        {"oro", "masternodedebug", &masternodedebug, true, true, false},
        {"oro", "startmasternode", &startmasternode, true, true, false},
        {"oro", "createmasternodekey", &createmasternodekey, true, true, false},
        {"oro", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"oro", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"oro", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"oro", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"oro", "getmasternodescores", &getmasternodescores, true, true, false},
        {"oro", "preparebudget", &preparebudget, true, true, false},
        {"oro", "submitbudget", &submitbudget, true, true, false},
        {"oro", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"oro", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"oro", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"oro", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"oro", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"oro", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"oro", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"oro", "checkbudgets", &checkbudgets, true, true, false},
        {"oro", "mnsync", &mnsync, true, true, false},
        {"oro", "spork", &spork, true, true, false},
        {"oro", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // {"zerocoin", "getzoroseed", &getzoroseed, false, false, true},
        // {"zerocoin", "setzoroseed", &setzoroseed, false, false, true},
        // {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        // {"zerocoin", "searchdzoro", &searchdzoro, false, false, true},
        // {"zerocoin", "dzorostate", &dzorostate, false, false, true},
...
{
    return "> oro-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41002/\n";
}
